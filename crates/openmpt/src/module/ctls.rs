...
mod tests {
    ...
    fn default_ctls_are_respected() {
        ...
        assert!(module.ctl_get_load_skip_samples().is_some());
        assert!(module.ctl_get_load_skip_patterns().is_some());
        assert!(module.ctl_get_load_skip_plugins().is_some());
        assert!(module.ctl_get_load_skip_subsongs_init().is_some());
        assert!(module.ctl_get_seek_sync_samples().is_some());
        assert!(module.ctl_get_play_tempo_factor().is_some());
        assert!(module.ctl_get_play_pitch_factor().is_some());
        assert!(module.ctl_get_dither().is_some());
    }
